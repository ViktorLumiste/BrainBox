    ...
    return (
        ...
        <div className={styles.TolkimineContainer}>
            ...
            <p className={styles.FillerText}>Seda teostavad meil tehnilise eriharidusega inimesed, kes on võimelised
                ...
                siis täpse hinnapakkumise tegemiseks palume võimaluse korral saata algmaterjal meile elektroonilisel
                kujul.</p>
            <p className={styles.FillerText}>Tehnikaalaste tekstide tõlkimise juures on suureks abiks tihe koostöö
                kliendiga, sest tavaliselt tunneb
                tellija ise terminoloogiat kõige paremini ja oskab anda juhiseid, millist terminoloogiat kasutada.
                Suuremahulistele töödele teeme ka soodustust.</p>
            ...
            <p className={styles.FillerText}>Juriidilisi tõlkeid teostavad meil juriidikale spetsialiseerunud tõlkijaid.
                ...
                Juriidiliste materjalide tõlkimisel on samuti oluline koostöö kliendiga, seda eriti nüansside
                lahtimõtestamisel.</p>
            ...
            <p className={styles.FillerText}>Tõlgitav tekst võib olla ka vaid sõna või kaks, kuid nende tõlkimine võib
                võtta aega tunde, et leida see
                kõige parem tõlge. See eeldab tõlkijalt loovat lähenemist ja laia silmaringi.</p>
            <p className={styles.FillerText}>Reklaamteksti tõlkimine eeldab ka väga head keeleoskust ja loovat
            ...
            <p className={styles.FillerText}>Meditsiinialaseid tekste tõlgivad alati meditsiinilise kõrgharidusega
                ...
                tõlget teha.</p>
            <p className={styles.FillerText}>Kvaliteetse tõlke tagab ka tõlkija ja kliendi koostöö. Kuna
                meditsiinitekstid on enamasti väga
                spetsiifilise terminoloogiaga, on oluline ka teada, kes on teksti lõpptarbija, et lihtsustada vajaduse
                korral termineid, et tekst oleks arusaadav ka tavalugejale, mitte vaid spetsialistile.</p>
            <p className={styles.FillerText}>Pane julgelt meid proovile! Meil on spetsialistid igale alale. Oleme
                tõlkinud näiteks helikopterite
                juhtimise juhendeid, epikriise, kohtudokumente ja ka Narva elektrijaama ehitusdokumente ja seadmete
                kasutusjuhendeid.</p>
        </div>
    );
};

export default EeTolkimine;